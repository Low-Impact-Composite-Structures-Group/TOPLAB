...
from src.system.tank_system import TankSystem, TankSystemConfig, TankConfig
from src.utilities.tank_geometry import create_tank_from_fuel_mass
...
class SystemOrchestrator:
    ...
    def _create_tank_geometries(self) -> List[Any]:
        ...
        for tank_id, geometry_data in self.scenario_config.tank_geometries.items():
            ...
            if 'fuel_mass' in geometry_data:
                ...
                from src.materials.nist_materials import NISTMaterial
    ...
    def _get_mission_profile(self, profile_name: str):
        ...
        from src.missions.mission_sections import MissionSection, OutFlow, InFlow
    ...
    def generate_plots(self, save_path: str = None) -> Any:
        ...
        try:
            ...
            if font_config:
                from src.plotting.plot_style_sb import update_font_settings
    ...
    def _generate_single_mission_plots(self, plotter, save_path: str = None, figure_prefix: str = None):
        ...
        # -------------------------------------------------------------------
        from src.coupling.inter_tank_coupling import ProportionalSplitCoupling, PressureTriggeredDischarge
