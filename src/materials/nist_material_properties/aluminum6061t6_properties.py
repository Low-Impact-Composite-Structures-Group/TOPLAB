"""
Aluminum 6061-T6 Temperature-Dependent Properties from NIST Data

This module provides polynomial functions for thermal conductivity and specific heat
of aluminum 6061-T6 based on NIST curve fits.

Data range: 4-300K
Equation range: 1-300K (thermal conductivity), 4-300K (specific heat)
Curve fit error: 0.5% (thermal conductivity), 5% (specific heat) relative to data
...
if __name__ == "__main__":
    ...
    print("Aluminum 6061-T6 Properties Test:")
    print("=" * 50)
    ...
    print("Curve fit errors: 0.5% (k), 5% (Cp) relative to data")
