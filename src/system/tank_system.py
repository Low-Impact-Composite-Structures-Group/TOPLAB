...
from src.coupling.inter_tank_coupling import PressureTriggeredValve, OHEXExtractionCoupling
from src.fluids.flow_physics import FlowPhysics
from src.peripheral_components.factory import build_peripheral_component_chain
...
class TankSystem:
    ...
    def _extract_mission_profile_data(self) -> dict:
        ...
        try:
            # Import flow types
            from src.missions.mission_sections import OutFlow
    ...
    def _setup_coupling_rules(self):
        ...
        for rule in self.coupling_rules:
            ...
            if rule_type == 'pressure_triggered_valve':
                ...
                from src.coupling.inter_tank_coupling import MissionAdaptivePressureValve
                ...
                from src.coupling.inter_tank_coupling import PressureGovernorValve
                ...
                from src.coupling.inter_tank_coupling import FeedforwardPressureEnforcer
                ...
                from src.coupling.inter_tank_coupling import MassFlowPIDControlledValve
                ...
                from src.coupling.inter_tank_coupling import OHEXExtractionCoupling
                ...
                from src.coupling.inter_tank_coupling import ProportionalSplitCoupling
                ...
                from src.coupling.inter_tank_coupling import PressureTriggeredDischarge
    ...
    def _get_flow_rate(self, time: float, tank_index: int, flow_type: str) -> float:
        ...
        try:
            # Import flow types
            from src.missions.mission_sections import InFlow, OutFlow
    ...
    def compute_coupling_stream_history(self, results: MultiTankResults) -> list:
        ...
        from src.coupling.inter_tank_coupling import (
