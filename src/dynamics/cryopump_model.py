...
class CryoPumpModel:
    ...
    def compute_pump_outlet_hydrogen(self, tank_pressure: float):
        """Compute the pump outlet hydrogen state for a target tank pressure.

        Returns a Hydrogen/TwoPhaseHydrogen object from `HydrogenRetriever`.
        """
...
# Backwards/Convenience API: module-level default instance + function
