...
def perform_analysis():
    ...
    min_pressure = config.get('refueling', {}).get('min pressure', None)
    min_temperature = config.get('refueling', {}).get('min temperature', None)
    max_pressure = config.get('refueling', {}).get('max pressure', None)
    initial_pressure = config.get('refueling', {}).get('initial pressure', None)
    initial_temperature = config.get('refueling', {}).get('initial temperature', None)
    initial_fill = config.get('refueling', {}).get('initial fill', None)
    mass_flow = config.get('refueling', {}).get('mass flow rate', None)
    duration = config.get('refueling', {}).get('duration', None)
    altitude = config.get('refueling', {}).get('altitude', None)
    mach_number = config.get('refueling', {}).get('mach number', None)
    target_fill = config.get('refueling', {}).get('target fill', None)
    target_mass = config.get('refueling', {}).get('target mass', None) 
