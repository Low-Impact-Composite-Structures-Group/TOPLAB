...
DEFAULT_REPORT_PATH = PROJECT_ROOT / "optimization" / "pressure_buffer_sweep" / "output" / "pressure_buffer_sweep.txt"
DEFAULT_SWEEP_CONFIG_PATH = PROJECT_ROOT / "optimization" / "pressure_buffer_sweep" / "pressure_buffer_sweep.yaml"
